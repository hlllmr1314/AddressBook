...
-(void)getAuthCode:(NSString *)phoneNumber
{
    ...
    } withToken:NO toJson:NO isNotForm:YES  parameterEncoding:AFFormURLParameterEncoding ];
    return;
...
{//18605884171
 ...
 //       [self showSelectDepartment];
        ...
        ((SHMUser *)[SHMUser sharedUser]).cellPhone = phoneNumber;        
    ...
    }withToken:NO toJson:NO isNotForm:NO  parameterEncoding:AFFormURLParameterEncoding];
